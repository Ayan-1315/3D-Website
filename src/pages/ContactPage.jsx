      ...
      <div className={styles.contentInner}>
        ...
        <div className={styles.scrollableArea}>
          <section className={styles.contactSection}>
            <a
              href="mailto:ayansen1315@gmail.com"
            ...
            >
              ...
              <label htmlFor="user-email" className="visually-hidden">
                Your Email
              </label>
              <input
                id="user-email"
              ...
              {/* 2. Textarea still uses 'feedbackBox' class */}
              <label htmlFor="feedback-box" className="visually-hidden">
