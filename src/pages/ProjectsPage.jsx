...
const projects = [
  {
    id: 1,
    title: "Snugger",
    desc: "Snugger is a real-time chat platform built with Socket.io and MongoDB, designed for instant and reliable communication across devices. It focuses on fast message delivery, minimal design, and scalability, providing a strong foundation for future AI integrations.",
    details: "Snugger began as an experiment in building a robust, event-driven chat system. Using Socket.io for bi-directional communication, it supports instant message updates, read receipts, group chats, and user status tracking. The backend runs on Fastify and MongoDB, ensuring efficient handling of concurrent connections. The project also demonstrates modular architecture — separating routes, controllers, and WebSocket handlers for cleaner management. Beyond messaging, Snugger taught me how to handle data persistence and scalability challenges common to real-world apps. Its design encourages extendability, like integrating AI-driven assistants or analytics, making it a reliable base for future interactive systems.",
